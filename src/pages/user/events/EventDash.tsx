    ...
    const fetchAllEvents = async () => {
      ...
      try {
        ...
        const validEvents = EventsData.filter((event: EventData) => {
          ...
          eventDate.setHours(0, 0, 0, 0); // Set the event time to the start of the day
      ...
      <div className="w-full h-full flex p-3 md:px-16 flex-col ">
        <div className="navbar border-b flex justify-around items-center border-gray-300 dark:border-neutral-700">
          ...
          <div className="bg--500 flex h-6 gap-7 items-center">
            <span onClick={openModal} className="dark:text-neutral-400 cursor-pointer text-sm items-center dark:bg-neutral-700 bg-neutral-200 px-2 py-1 rounded-lg text-neutral-700 dark:hover:text-neutral-300 flex">
              <Plus size={15} className="mr-1" /> Add Event
            </span>
            <Link to="/event/past"><span onClick={openModal} className="dark:text-neutral-400 cursor-pointer text-sm items-center dark:bg-neutral-700 bg-neutral-200 px-2 py-1 rounded-lg text-neutral-700 dark:hover:text-neutral-300 flex">
        ...
        <h1 className=" font-semibold text-2xl mt-6 mb-6">
          My Schedules
        </h1>
