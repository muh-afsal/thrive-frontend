    ...
    <>
      <div className="bg--400  w-16 h-screen flex flex-col justify-center items-center shadow-[rgba(50,_50,_105,_0.15)_0px_2px_5px_0px,_rgba(0,_0,_0,_0.05)_0px_1px_1px_0px]">
        ...
        <div className=" h-[90%] w-14 flex justify-center items-center">
          ...
          <Link to="/home"><li className="w-11 h-11 bg-contain flex justify-center items-center "><GoHomeFill  color="#36454F" size={20} /></li></Link>
            ...
            <Link to="/payment-start"><li className="w-11 h-11 bg-contain flex justify-center items-center"><FaUnlockKeyhole color="#36454F" size={20} /></li></Link>
            <Link to="/profile"><li className="w-11 h-11 bg-contain flex justify-center items-center"><IoSettingsSharp color="#36454F" size={20} /></li></Link>
          </ul>
        </div>
      </div>
    </>
